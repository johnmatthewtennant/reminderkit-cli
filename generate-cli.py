#!/usr/bin/env python3
"""
Generate reminderkit.m from ReminderKit private API.

USAGE:
    python3 generate-cli.py > reminderkit.m
    # Then: make reminderkit

MAINTENANCE:
    This generator produces reminderkit.m — the Objective-C source for the
    ...
    To add a new READ property:
        ...
        4. Regenerate: python3 generate-cli.py > reminderkit.m && make reminderkit
    ...
    Architecture:
        ...
        generate-cli.py   ->  generates reminderkit.m from config dicts (this file)
        reminderkit.m     ->  AUTO-GENERATED, do not edit manually
...
def generate_header():
    return '''// Originally scaffolded by generate-cli.py — now maintained manually
...
def generate_reminder_to_dict():
    ...
    lines.append('                if (attUrl) dict[@"url"] = [attUrl absoluteString];')
    lines.append('            }')
    lines.append('        }')
