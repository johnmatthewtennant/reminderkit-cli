...
static void usage(void) {
    ...
    fprintf(stderr, "  reminderkit add --title <title> [--list <name>] [--section <name>] [--notes <value|->] [--completed <value>] [--priority <value>] [--flagged <value>] [--due-date <value>] [--start-date <value>] [--url <value>] [--parent-id <id>] [--after-id <sibling-id>] [--position <N>]\n");
    fprintf(stderr, "  reminderkit update --id <id> [--title <value>] [--list <name>] [--section <name>] [--notes <value|->] [--append-notes <value|->] [--completed <value>] [--priority <value>] [--flagged <value>] [--due-date <value>] [--start-date <value>] [--url <value>] [--clear-url] [--remove-parent] [--remove-from-list] [--parent-id <id>] [--after-id <sibling-id>] [--position <N>] [--to-list <name>]\n");
...
int main(int argc, const char *argv[]) {
    @autoreleasepool {
        ...
        if ([[[NSProcessInfo processInfo] environment][@"REMINDERKIT_SELF_DISCLAIM"] length] > 0) {
