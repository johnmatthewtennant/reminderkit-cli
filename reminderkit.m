...
static void usage(void) {
    ...
    fprintf(stderr, "  reminderkit update (<title> | --id <id>) [--list <name>] [--title <value>] [--notes <value>] [--completed <value>] [--priority <value>] [--flagged <value>] [--due-date <value>] [--start-date <value>] [--remove-parent] [--remove-from-list] [--parent-id <id>] [--parent-title <title>] [--to-list <name>]\n");
